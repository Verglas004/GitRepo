public class Spell
{
    ...
    private boolean bard, cleric, druid, paladin, ranger, sorcerer, warlock, wizard;

    // Name, Description, Page #, Level, School, Casting Time, Ritual, V, S, M, Concentration, Bard, Cleric, Druid, Paladin, Ranger, Sorcerer,
// Warlock, Wizard
    // 19 columns
    ...
    public Spell(String name2, String description2, int pg2, int level2, String school2, String castingTime2,  boolean ritual2,
	    boolean v2, boolean s2, boolean m2, boolean concentration2, boolean bard2, boolean cleric2, boolean druid2, boolean paladin2,
	    boolean ranger2, boolean sorcerer2, boolean warlock2, boolean wizard2) {
	setName(name2);
    ...
    // ? Druidcraft Small nature effect; predict weather, expedite small plant growth, snuff light, harmless sensory effect Trans 1 a 30 ft V,S
// Instantaneous P 236
